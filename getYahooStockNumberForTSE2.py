...
def main():
    ...
    stock_cat.remove('上市')
    stock_cat.remove('櫃憑證')
    stock_cat.remove('櫃認購')
    stock_cat.remove('櫃認售')
    stock_cat.remove('櫃指數類')
    stock_cat.remove('櫃牛證')
    stock_cat.remove('櫃熊證')
